...
from ehrml.utils import Ensemble


def run(dirPath, idColumns, targetColumn, measurementDateColumn, anchorDateColumn, windowStart, windowEnd, configFile, savePath):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-cf', '--config_file', nargs=1, default=['ehrml.config.config'],
    ...
    log.info('args.config_file: ' + str(args.config_file[0]))
